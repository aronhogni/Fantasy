    ...
    <div
      ...
      <div style={S.pMain}>
        {/* ============================================================
            ...
            ============================================================ */}
        <span style={S.pEp} title={"Expected points for this gameweek. The LEVEL is his own measured base: points per 90 so far this season, shrunk towards last season's rate (so two big games do not read as a projection), multiplied by his recent minutes. What this app adds on top is the FIXTURE: that base is multiplied by the measured points-per-tier figure for his position at this fixture's FFDR, and by availability. That figure is then recalibrated against five seasons of results: the raw model ranks well but ran about 1.6 points high for the very best players, so it is passed through a curve that compresses the top without changing anyone's order. Before the season starts, or when his minutes history is missing, FPL's own ep_next is used instead and is left uncalibrated - it is their number, not ours. Start probability is NOT a multiplier here - that was measured and rejected, because the FPL bench does that job for free."}>
