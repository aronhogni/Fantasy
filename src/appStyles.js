...
export const S = {
  ...
  /* ---- KAUP-/SOLU-LISTINN (8.9.2026) ----
     Tveir dalkar sem BROTNA nidur a mjoum skjá (`flexWrap`), ekki fast
     tveggja-dalka net: 390 px gefur annars 150 px dalka thar sem
     nofnin klippast. Sama regla og taflan i Player stats lærdi.     */
  bsCols: { display:"flex", gap:10, flexWrap:"wrap", margin:"8px 0 12px" },
  bsCol: { flex:"1 1 260px", minWidth:0, background:C.cardAlt, borderRadius:8,
    padding:"8px 10px", border:`1px solid ${C.border}` },
  bsColHead: { display:"flex", alignItems:"baseline", gap:6, fontSize:12,
    fontWeight:700, color:C.text, marginBottom:6 },
  bsColNote: { fontSize:10, fontWeight:400, color:C.text2 },
  bsInput: { width:"100%", boxSizing:"border-box", background:C.card,
    border:`1px solid ${C.borderStrong}`, borderRadius:6, padding:"5px 8px",
    fontSize:12, color:C.text },
  bsHits: { display:"flex", flexDirection:"column", gap:2, marginTop:4 },
  bsHit: { display:"flex", alignItems:"center", gap:6, background:C.card,
    border:`1px solid ${C.border}`, borderRadius:6, padding:"4px 8px",
    fontSize:12, color:C.text, cursor:"pointer", textAlign:"left" },
  bsHitPos: { marginLeft:"auto", fontSize:9.5, color:C.text2, fontWeight:700 },
  bsChips: { display:"flex", gap:5, flexWrap:"wrap", marginTop:6 },
  bsChip: { display:"inline-flex", alignItems:"center", gap:4, background:C.card,
    border:`1px solid ${C.borderStrong}`, borderRadius:12, padding:"3px 4px 3px 9px",
    fontSize:11.5, color:C.text },
  bsChipPos: { fontSize:9, color:C.text2, fontWeight:700 },
  bsX: { background:"none", border:"none", color:C.text2, cursor:"pointer",
    fontSize:11, lineHeight:1, padding:"1px 3px" },
  bsEmpty: { fontSize:11, color:C.text2, fontStyle:"italic" },
  bsSay: { background:C.cardAlt, borderRadius:8, padding:"8px 10px", fontSize:11,
    color:C.text2, lineHeight:1.5, marginBottom:10 },
  bsMoves: { display:"flex", flexDirection:"column", gap:8, marginBottom:10 },
  bsMove: { border:`1px solid ${C.border}`, borderRadius:8, padding:"8px 10px" },
  bsMoveHead: { display:"flex", alignItems:"center", gap:6, fontSize:12.5,
    color:C.text, flexWrap:"wrap" },
  bsWeek: { fontFamily:mono, fontSize:11, fontWeight:800, borderRadius:5,
  ...
  bsPathRow: { display:"flex", alignItems:"center", gap:3, marginTop:5,
    flexWrap:"wrap" },
  bsPathLbl: { fontSize:9.5, color:C.text2, fontWeight:700, width:22,
    flexShrink:0, textTransform:"uppercase" },
  bsCell: { fontFamily:mono, fontSize:9.5, fontWeight:700, borderRadius:4,
    padding:"2px 4px", minWidth:26, textAlign:"center" },
  bsWeak: { border:`1px dashed ${C.borderStrong}`, borderRadius:8,
    padding:"8px 10px", marginBottom:10 },
  bsWeakHead: { fontSize:12, fontWeight:700, color:C.text, marginBottom:5 },
  bsWeakRow: { display:"flex", alignItems:"center", gap:6, fontSize:12,
    color:C.text2, padding:"2px 0" },
  bsWeakNet: { fontFamily:mono, fontSize:11.5, color:C.text2 },
  bsFlag: { fontFamily:mono, fontSize:9, fontWeight:800, color:"#b3261e",
    border:"1px solid #b3261e", borderRadius:4, padding:"0 3px", marginLeft:4 },
  bsWeakFlag: { fontSize:10.5, color:C.text2, lineHeight:1.5, marginTop:5,
    borderLeft:"2px solid #b3261e", paddingLeft:7 },
  bsWeakNote: { fontSize:10.5, color:C.text2, lineHeight:1.5, marginTop:5 },
