...
let failed = 0;
for (const [f, loader] of [["model.test.mjs"], ["stats.test.mjs"], ["ffdr-backtest.mjs"], ["ffdr-walkforward.mjs"], ["ffdr-player-points.mjs"], ["travel-measure.mjs"], ["smoke.test.mjs", true]]) {
  console.log(`\n${"=".repeat(56)}\n  ${f}\n${"=".repeat(56)}`);
...
console.log(`\n${"=".repeat(56)}`);
console.log(failed ? `HEILD: ${failed} prófasafn féll` : "HEILD: öll sjö prófasöfnin græn");
