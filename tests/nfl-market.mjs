...
import { teamMarketStrength, americanToDecimal, ESPN_TEAM_ID }
  from "../scripts/nfl/sources/espnodds.mjs";
import { impliedTeamTotals } from "../src-nfl/model.js";
import { NFL_TEAMS } from "../src-nfl/names.js";

const DATA = path.resolve(new URL(".", import.meta.url).pathname, "..", "data-nfl");
let fail = 0;
