/* ============================================================
   FROSIÐ AFRIT — src/model.js við 7890ca5 (27.7.2026 23:51) — SIDASTA commit i gaer

   Notað AÐEINS af tests/ffdr-cs-versions.mjs til að bera saman útgáfur.
   ÞESSI SKRÁ MÁ ALDREI BREYTAST — hún er söguleg heimild, ekki kóði í
   notkun. Samanburður sem endurgerir gamla kóðann í staðinn fyrir að
   flytja hann inn mælir ekkert.
   ============================================================ */
/* ============================================================
