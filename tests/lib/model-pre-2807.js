/* ============================================================
   FROSIÐ AFRIT — src/model.js EINS OG ÞAÐ VAR VIÐ 8b81b9f (27.7.2026),
   þ.e. FYRIR allar FFDR-breytingar 27.–28. júlí.

   TILGANGUR: tests/ffdr-old-vs-new.mjs mælir gamla líkanið gegn nýja á
   15 tímabilum. Það á að flytja inn GAMLA KÓÐANN, ekki endurgerð af
   honum — endurgerð getur rekið og þá mælir samanburðurinn ekkert.

   ÞESSI SKRÁ MÁ ALDREI BREYTAST. Hún er söguleg heimild, ekki kóði í
   notkun. Ef þú ætlar að "laga" eitthvað hér, þá ertu að laga vitlausa
   skrá — sjá src/model.js.
   ============================================================ */
/* ============================================================
